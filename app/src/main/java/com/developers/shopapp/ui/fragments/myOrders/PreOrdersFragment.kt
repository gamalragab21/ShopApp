...
class PreOrdersFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        hideBottomSheetOrShowWhenScroll(
            recyclerView = binding.preOrderFragmentRecycler,
    ...
    private fun subscribeToObservers() {
        lifecycleScope.launchWhenStarted {
            launch {
                ordersViewModels.preOrderStatus.collect(EventObserver(
                    onSuccess = { orders ->
    ...
    private fun setupRecyclerViewRecent() = binding.preOrderFragmentRecycler.apply {
        itemAnimator = null
